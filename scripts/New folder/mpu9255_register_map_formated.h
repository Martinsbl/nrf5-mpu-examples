...
#define MPU_REG_GYRO_CONFIG        0x1B // Dec 27,  R/W,  XGYRO_CtenYGYRO_CtenZGYRO_Cten
...
#define MPU_REG_FIFO_EN            0x23 // Dec 35,  R/W,  TEMP_FIFO_ENGYRO_XOUTGYRO_YOUTGYRO_ZO
#define MPU_REG_I2C_MST_CTRL       0x24 // Dec 36,  R/W,  MULT
#define MPU_REG_I2C_MST_CTRL       0x24 // Dec 36,  R/W,  MULT_MST_ENWAIT_FOR_ESSLV_3_FIFO_ENI2C_MST
...
#define MPU_REG_I2C_SLV0_CTRL      0x27 // Dec 39,  R/W,  I2C_SLV0_ENI2C_SLV0_BYTE_SWI2C_SLV0_REG_DISI2C_SLV0
...
#define MPU_REG_I2C_SLV1_CTRL      0x2A // Dec 42,  R/W,  I2C_SLV1_ENI2C_SLV1_BYTE_SWI2C_SLV1_REG_DISI2C_SLV1
...
#define MPU_REG_I2C_SLV2_CTRL      0x2D // Dec 45,  R/W,  I2C_SLV2_ENI2C_SLV2_BYTE_SWI2C_SLV2_REG_DISI2C_SLV2
...
#define MPU_REG_I2C_SLV3_CTRL      0x30 // Dec 48,  R/W,  I2C_SLV3_ENI2C_SLV3_BYTE_SWI2C_SLV3_REG_DISI2C_SLV3
...
#define MPU_REG_I2C_SLV4_CTRL      0x34 // Dec 52,  R/W,  I2C_SLV4_ENSLV4_DONE_INT_ENI2C_SLV4_REG_DIS I2C_MST_DLY[4:0]7 of 54 MPU-9255-00MPU-9255 Register Map and DescriptionsDocument Number: RM-000008Revision: 1.0Release Date: 10/10/2014Addr(Hex)Addr
#define MPU_REG_I2C_SLV4_DI        0x35 // Dec 53,  R,    I2C_SLV4_DI[7:0]
#define MPU_REG_I2C_MST_STATUS     0x36 // Dec 54,  R,    PASS_
#define MPU_REG_I2C_MST_STATUS     0x36 // Dec 54,  R,    PASS_THROUGHI2C_SLV4_DONEI2C_LOST_ARBI2C_SLV4_NACKI2C_SLV3_NACKI2C_SLV2_NACKI2C_SLV1_NACKI2C_SLV0
#define MPU_REG_INT_PIN_CFG        0x37 // Dec 55,  R/W,  ACTL OPEN LATCH
#define MPU_REG_INT_PIN_CFG        0x37 // Dec 55,  R/W,  ACTL OPEN LATCH_INT_ENINT_ANYRD_2CLEARACTL_FSYNCFSYNC_INT_MODE_ENBYPASS
#define MPU_REG_INT_ENABLE         0x38 // Dec 56,  R/W,  - WOM_EN -
#define MPU_REG_INT_ENABLE         0x38 // Dec 56,  R/W,  - WOM_EN -FIFO_OFLOW_ENFSYNC_INT_EN - -RAW_RDY_
#define MPU_REG_INT_STATUS         0x3A // Dec 58,  R,    - WOM_INT -
#define MPU_REG_INT_STATUS         0x3A // Dec 58,  R,    - WOM_INT -FIFO_OFLOW_INTFSYNC_INT - -RAW_DATA
...
#define MPU_REG_I2C_SLV2_DO        0x65 // Dec 101, R/W,  I2C_SLV2_DO[7:0]8 of 54 MPU-9255-00MPU-9255 Register Map and DescriptionsDocument Number: RM-000008Revision: 1.0Release Date: 10/10/2014Addr(Hex)Addr
#define MPU_REG_I2C_SLV3_DO        0x66 // Dec 102, R/W,  I2C_SLV3_DO[7:0]
#define MPU_REG_I2C_MST_DELAY_CTRL 0x67 // Dec 103, R/W,  DELAY_ES
#define MPU_REG_I2C_MST_DELAY_CTRL 0x67 // Dec 103, R/W,  DELAY_ES_SHADOW - -I2C_SLV4_DLY_ENI2C_SLV3_DLY_ENI2C_SLV2_DLY_ENI2C_SLV1_DLY_ENI2C_SLV0
#define MPU_REG_SIGNAL_PATH_RESET  0x68 // Dec 104, R/W,  - - - - - GYRO
#define MPU_REG_SIGNAL_PATH_RESET  0x68 // Dec 104, R/W,  - - - - - GYRO_RSTACCEL_RSTTEMP
#define MPU_REG_MOT_DETECT_CTRL    0x69 // Dec 105, R/W,  ACCEL_INT
#define MPU_REG_MOT_DETECT_CTRL    0x69 // Dec 105, R/W,  ACCEL_INTEL_ENACCEL_INT
#define MPU_REG_USER_CTRL          0x6A // Dec 106, R/W,  - FIFO_EN I2C_MST
#define MPU_REG_USER_CTRL          0x6A // Dec 106, R/W,  - FIFO_EN I2C_MST_ENI2C_IF_DIS -FIFO_RSTI2C_MST_RSTSIG_COND
