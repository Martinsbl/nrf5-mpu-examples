    ...
    for file in files:
		...
		if (file.endswith(".uvprojx") or file.endswith(".uvoptx")) and ("nrf5-ble-uart-mpu-data-ready-interrupts" in filepath) : # find project files that is not specific to nrf52
			if "twi" in filepath:
				...
				# filedata = filedata.replace('ble_app_template_s130_pca10028', 'spi_sensor_pca10028')
				# filedata = filedata.replace('ble_app_template_s130_pca10040', 'spi_sensor_pca10040')
