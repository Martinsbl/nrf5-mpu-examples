...
#define MPU_ERROR_BUFFER_TOO_SMALL (MPU_MPU_BASE_NUM + 2)
...
/**@brief Event handler used to pass SPI events from main application to the MPU library
 *
 * @param[in]   evt             SPI driver event
 ...
 * configurations.
 *
 * @param[in]   p_instance      Instance of nRF5x SPI module
 * @retval      uint32_t        Error code
 */
